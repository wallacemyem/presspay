  ...
  <script src="<?= base_url() ?>public/plugins/nice-select/jquery.nice-select.min.js"></script>
  <script src="<?= base_url() ?>public/plugins/aos/aos.min.js"></script>
  <script src="<?= base_url() ?>public/plugins/counter-up/jquery.counterup.min.js"></script>
  <script src="<?= base_url() ?>public/plugins/counter-up/waypoints.min.js"></script>
